...
export const faqs: FAQ[] = [
  ...
  {
    question: 'A aula gratuita tem algum compromisso de compra?',
    answer:
      'Absolutamente nenhum. A aula demonstrativa é 100% gratuita, sem cartão de crédito e sem compromisso. Você conhece a metodologia, o espaço e os professores — e decide com calma.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Nossas aulas são presenciais em Limeira/SP, em uma estrutura moderna, projetada para criar imersão no idioma e facilitar a conversação natural.',
  },
  {
    question: 'Quanto tempo leva para ver resultados reais?',
    answer:
      'Com prática consistente, nossos alunos relatam ganho de confiança e fluência para situações do dia a dia já nos primeiros meses. O plano de evolução personalizado que você recebe na aula demo define metas claras para a sua jornada.',
  },
  {
